...
public class SampleCoverVideo extends StandardGSYVideoPlayer {
    ...
    private OnPlayTimeChangeListener mListener;
    ...
    public void setListener(OnPlayTimeChangeListener listener) {
    ...
    protected void setProgressAndTime(int progress, int secProgress, int currentTime, int totalTime, boolean forceChange) {
        ...
        Logger.d("progress = %s ,secProgress = %s ,currentTime = %s,totalTime = %s, forceChange= %s",progress,secProgress,currentTime,totalTime,forceChange);

        if(mListener != null){
            mListener.onProgress(currentTime,totalTime);
        }
